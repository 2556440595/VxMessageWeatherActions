...
public class AllConfig {
    public static final String VxAppId = "wxa77b84cbdea9ab36";
    public static final String VxAppSecret = "358a1c49c37c303646e2b21e6cd1f4dc";
    public static final String WeatherKey = "abab9ecdc4655fd5107c83860dd9c195";
    ...
    private static void init(){
        ...
        userList.add(getUser(
                "wxa77b84cbdea9ab36",//扫码关注你的测试号以后，测试平台会出现TA的微信号
                "rASZRShx1K7qi0HlDdCD3rLzQpIJjET3q10q11N62Cg",//要给这个人发送的模板ID
                "亲爱的娜娜小公主",//咋称呼这个人
                "韩国首尔",//这个人的详细地址
                "首尔",//这个人在的城市
                new BirthDay(1997,10,24,false,false),//分别代表年、月、日、是否是农历(true为农历、false为公历)、是否统计天数(true为统计，false为倒计时)
                new BirthDay(2001,7,17,false,false),
